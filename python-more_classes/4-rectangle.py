...
by its width and height, and can compute its area, perimeter,
print the rectangle using '#', and provide a reproducible
...
class Rectangle:
    ...
    and height attributes, and provides methods to calculate
    area, perimeter, print it, and recreate the instance.
    """
